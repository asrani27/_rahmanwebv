    ...
    <div class="glass-effect rounded-2xl shadow-xl p-6 mb-8 border border-white/20">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-800 mb-2">Edit SKPD</h1>
                    <p class="text-gray-600">Edit data Satuan Kerja Perangkat Daerah</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                    <div class="flex items-start">
                        ...
                        <div>
                            <p class="font-medium text-blue-700">Informasi</p>
                            <p class="text-sm text-blue-600 mt-1">Data SKPD dibuat pada {{ $skpd->created_at->format('d/m/Y H:i') }}</p>
                        </div>
                    </div>
                </div>
            </div>
